...
function pay() {
  ...
  let content = `
    <div style="text-align:center;">
      <img src="logo.png" style="max-width:120px;"><br>
  ...
  content += `<hr><strong>TOTAL: ${total.toFixed(2)}€</strong><br><br>MERCI !`;
  ...
  doc.open();
  doc.write(`<body style="font-family: monospace; font-size:18px;">${content}</body>`);
  doc.close();
